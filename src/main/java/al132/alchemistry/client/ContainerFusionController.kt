...
class ContainerFusionController(playerInv: InventoryPlayer,
    ...
    override fun addOwnSlots() {
        this.addSlotToContainer(FusionSlotHandler(tile, tile.input, 0, 44, 53))
        this.addSlotToContainer(FusionSlotHandler(tile, tile.input, 1, 44 + 18, 53))
        this.addSlotToContainer(SlotItemHandler(tile.output, 0, 134, 53))
    }
}